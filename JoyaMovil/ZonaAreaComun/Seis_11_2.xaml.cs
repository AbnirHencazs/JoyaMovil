...
namespace JoyaMovil
{
    public partial class Seis_11_2 : ContentPage
    {
        public Seis_11_2()
        {
            InitializeComponent();
        ...
        //Funcionabilidad
        PageLampara fogata = new PageLampara();
        void AccionOnOff(Object sender, EventArgs args)
        {
            fogata.Turn(CANdata, Accion, "Fogata", (ImageButton)sender);
        }
        void Seleccion(Object sender, EventArgs args)
        {
            fogata.Toogled((ImageButton)sender);
            fogata.FocusImageButton(Accion, "BotonOnOff", null);
        }
        //Navegacion
