...
namespace JoyaMovil
{
    public partial class Seis_10_3 : ContentPage
    {
        public Seis_10_3()
        {
            InitializeComponent();
        ...
        //Funcionabilidad
        PageLampara murolloron = new PageLampara();
        void AccionOnOff(Object sender, EventArgs args)
        {
            murolloron.Turn(CANdata, Accion, "MuroLloron", (ImageButton)sender);
        }
        void Seleccion(Object sender, EventArgs args)
        {
            murolloron.Toogled((ImageButton)sender);
            murolloron.FocusImageButton(Accion, "BotonOnOff", null);
        }
        //Navegacion
